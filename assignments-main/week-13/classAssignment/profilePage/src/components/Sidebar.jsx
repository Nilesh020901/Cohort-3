...
const Sidebar = () => {
    ...
    return (
        <div bg-white>
            <button onClick={() => setOpen(e => !e)} className='text-amber-500 m-4'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75" />
                </svg>
            </button>
            {open &&
                <div className="hidden md:block w-64 h-screen text-gray-500 p-4">
                    <div className='flex items-center justify-between'>
                        <div className="flex items-center justify-center text-md gap-1 bg-sky-950 p-1 rounded-lg">
                            <div><svg className="text-white w-3 h-3 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512"><path d="M64 0C28.7 0 0 28.7 0 64L0 352c0 35.3 28.7 64 64 64l176 0-10.7 32L160 448c-17.7 0-32 14.3-32 32s14.3 32 32 32l256 0c17.7 0 32-14.3 32-32s-14.3-32-32-32l-69.3 0L336 416l176 0c35.3 0 64-28.7 64-64l0-288c0-35.3-28.7-64-64-64L64 0zM512 64l0 224L64 288 64 64l448 0z" /></svg></div>
                            <div className="text-white tracking-wide">Webinar<span className="text-teal-400">.gg</span></div>
                        </div>
                        <div><img src={nileshImg1} alt='profile-img'
                            className="w-11 h-11 rounded-xl" />
                        </div>
                    </div>
                    <nav className='mt-7'>
                        <ul className='font-semibold text-md flex flex-col gap-3'>
                            <li className="p-2 hover:bg-neutral-100 rounded-lg">
                                <div className='flex items-center justify-between hover:text-sky-950'>
                                    <div>Home</div>
