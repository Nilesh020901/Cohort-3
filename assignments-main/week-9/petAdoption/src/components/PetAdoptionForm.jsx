    ...
    return (
      <div className='form'>
        <div>
          ...
          <input type='text' name='petName' placeholder='Pet Name' value={petName} onChange={handleChange} />
        ...
        <div>
          ...
          <input type='text' name='breed' placeholder='Breed' value={breed} onChange={handleChange} />
          <small>{errors.breed}</small>
        </div>
        <div>
          <label htmlFor='adopterName'>Your Name</label>
          <input type='text' name='adopterName' placeholder='Your Name' value={adopterName} onChange={handleChange} />
