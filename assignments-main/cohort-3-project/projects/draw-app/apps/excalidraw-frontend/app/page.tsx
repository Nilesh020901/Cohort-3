          ...
          <div className="pt-20 pb-24 text-center">
            ...
            <div className="flex gap-4 justify-center">
              <button className="px-8 py-4 bg-indigo-600 text-white rounded-2xl font-fredoka text-lg
                hover:bg-indigo-700 transition-colors flex items-center gap-2 shadow-lg hover:shadow-xl">
                Start Drawing <ArrowRight className="h-5 w-5" />
              </button>
              <button className="px-8 py-4 bg-white text-gray-700 rounded-2xl font-fredoka text-lg
                border-2 border-gray-200 hover:border-gray-300 transition-colors flex items-center gap-2 shadow-lg hover:shadow-xl">
